...
void check_all_fns() {
  ...
  acos(a);
  // [CXX-P2001]: 5 "Call to `acosh(..)` implicitly promotes `float` to
  // `double`"
  acosh(a);
  // [CXX-P2001]: 5 "Call to `asin(..)` implicitly promotes `float` to `double`"
  asin(a);
  // [CXX-P2001]: 5 "Call to `asinh(..)` implicitly promotes `float` to
  // `double`"
  asinh(a);
  // [CXX-P2001]: 5 "Call to `atan2(..)` implicitly promotes `float` to
  // `double`"
  atan2(a, b);
  // [CXX-P2001]: 5 "Call to `atan(..)` implicitly promotes `float` to `double`"
  atan(a);
  // [CXX-P2001]: 5 "Call to `atanh(..)` implicitly promotes `float` to
  // `double`"
  atanh(a);
  ...
  ceil(a);
  // [CXX-P2001]: 5 "Call to `copysign(..)` implicitly promotes `float` to
  // `double`"
  copysign(a, b);
  ...
  exp(a);
  // [CXX-P2001]: 5 "Call to `expm1(..)` implicitly promotes `float` to
  // `double`"
  expm1(a);
  ...
  fdim(a, b);
  // [CXX-P2001]: 5 "Call to `floor(..)` implicitly promotes `float` to
  // `double`"
  floor(a);
  ...
  fmod(a, b);
  // [CXX-P2001]: 5 "Call to `frexp(..)` implicitly promotes `float` to
  // `double`"
  frexp(a, int_ptr);
  // [CXX-P2001]: 5 "Call to `hypot(..)` implicitly promotes `float` to
  // `double`"
  hypot(a, b);
  // [CXX-P2001]: 5 "Call to `ilogb(..)` implicitly promotes `float` to
  // `double`"
  ilogb(a);
  // [CXX-P2001]: 5 "Call to `ldexp(..)` implicitly promotes `float` to
  // `double`"
  ldexp(a, b);
  // [CXX-P2001]: 5 "Call to `lgamma(..)` implicitly promotes `float` to
  // `double`"
  lgamma(a);
  // [CXX-P2001]: 5 "Call to `llrint(..)` implicitly promotes `float` to
  // `double`"
  llrint(a);
  // [CXX-P2001]: 5 "Call to `llround(..)` implicitly promotes `float` to
  // `double`"
  llround(a);
  // [CXX-P2001]: 5 "Call to `log10(..)` implicitly promotes `float` to
  // `double`"
  log10(a);
  // [CXX-P2001]: 5 "Call to `log1p(..)` implicitly promotes `float` to
  // `double`"
  log1p(a);
  ...
  logb(a);
  // [CXX-P2001]: 5 "Call to `lrint(..)` implicitly promotes `float` to
  // `double`"
  lrint(a);
  // [CXX-P2001]: 5 "Call to `lround(..)` implicitly promotes `float` to
  // `double`"
  lround(a);
  // [CXX-P2001]: 5 "Call to `nearbyint(..)` implicitly promotes `float` to
  // `double`"
  nearbyint(a);
  // [CXX-P2001]: 5 "Call to `nextafter(..)` implicitly promotes `float` to
  // `double`"
  nextafter(a, b);
  // [CXX-P2001]: 5 "Call to `nexttoward(..)` implicitly promotes `float` to
  // `double`"
  nexttoward(a, b);
  // [CXX-P2001]: 5 "Call to `pow(..)` implicitly promotes `float` to `double`"
  pow(a, b);
  // [CXX-P2001]: 5 "Call to `remainder(..)` implicitly promotes `float` to
  // `double`"
  remainder(a, b);
  // [CXX-P2001]: 5 "Call to `remquo(..)` implicitly promotes `float` to
  // `double`"
  remquo(a, b, int_ptr);
  // [CXX-P2001]: 5 "Call to `rint(..)` implicitly promotes `float` to `double`"
  rint(a);
  // [CXX-P2001]: 5 "Call to `round(..)` implicitly promotes `float` to
  // `double`"
  round(a);
  // [CXX-P2001]: 5 "Call to `scalbln(..)` implicitly promotes `float` to
  // `double`"
  scalbln(a, l);
  // [CXX-P2001]: 5 "Call to `scalbn(..)` implicitly promotes `float` to
  // `double`"
  scalbn(a, i);
  ...
  tanh(a);
  // [CXX-P2001]: 5 "Call to `tgamma(..)` implicitly promotes `float` to
  // `double`"
  tgamma(a);
  // [CXX-P2001]: 5 "Call to `trunc(..)` implicitly promotes `float` to
  // `double`"
  trunc(a);
}
