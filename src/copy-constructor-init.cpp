...
template <class C> class Copyable4 {
public:
  Copyable4() = default;
...
template <class T, class S> class Copyable5 {
public:
  Copyable5() = default;
...
template <typename T> using CopyableAlias = Copyable5<T, int>;

typedef Copyable5<int, int> CopyableAlias2;

namespace std {
class X : public Copyable2 {
  // [CXX-W2003]: 5 "`std::X::X(..)` is calling a base constructor other than
...
class X2 : public Copyable2 {
  // [CXX-W2003]: 3 "`X2::X2(..)` is calling a base constructor other than the
  // copy constructor"
  X2(const X2 &other) {}
};

class X2_A : public Copyable2 {
  // [CXX-W2003]: 3 "`X2_A::X2_A(..)` is calling a base constructor other than
  // the copy constructor"
  X2_A(const X2_A &) {}
};

class X3 : public Copyable, public Copyable2 {
  // [CXX-W2003]: 3 "`X3::X3(..)` is calling a base constructor other than the
  // copy constructor"
  X3(const X3 &other) : Copyable(other) {}
};

class X4 : public Copyable {
  // [CXX-W2003]: 3 "`X4::X4(..)` is calling a base constructor other than the
  // copy constructor"
  X4(const X4 &other) : Copyable() {}
};

class X5 : public Copyable3 {
  // [CXX-W2003]: 3 "`X5::X5(..)` is calling a base constructor other than the
  // copy constructor"
  X5(const X5 &other) {}
};

class X6 : public Copyable2, public Copyable3 {
  // [CXX-W2003]: 3 "`X6::X6(..)` is calling a base constructor other than the
  // copy constructor"
  X6(const X6 &other) {}
};

class X7 : public Copyable, public Copyable2 {
  // [CXX-W2003]: 3 "`X7::X7(..)` is calling a base constructor other than the
  // copy constructor"
...
class X9 : public Copyable4<int> {
  // [CXX-W2003]: 3 "`X9::X9(..)` is calling a base constructor other than the
  // copy constructor"
  X9(const X9 &other) : Copyable4() {}
};

class X10 : public Copyable4<int> {
  // [CXX-W2003]: 3 "`X10::X10(..)` is calling a base constructor other than the
  // copy constructor"
  X10(const X10 &other) {}
};

class X11 : public Copyable5<int, float> {
  // [CXX-W2003]: 3 "`X11::X11(..)` is calling a base constructor other than the
  // copy constructor"
  X11(const X11 &other) {}
};

class X12 : public CopyableAlias<float> {
  // [CXX-W2003]: 3 "`X12::X12(..)` is calling a base constructor other than the
  // copy constructor"
  X12(const X12 &other) {}
};

template <typename T> class X13 : T {
  X13(const X13 &other) {}
};
...
class X15 : public CopyableAlias2 {
  // [CXX-W2003]: 3 "`X15::X15(..)` is calling a base constructor other than the
  // copy constructor"
  X15(const X15 &other) {}
};
...
class X18 : private Copyable {
  // [CXX-W2003]: 3 "`X18::X18(..)` is calling a base constructor other than the
  // copy constructor"
  X18(const X18 &other) {}
};
